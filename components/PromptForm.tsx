...
const PromptForm: React.FC<PromptFormProps> = ({
  ...
  switch (generationMode) {
    ...
    case GenerationMode.EXTEND_VIDEO:
      const hasNoVideo = !inputVideo;
      const hasNoPromptExt = !prompt.trim();
      isSubmitDisabled = hasNoVideo || hasNoPromptExt;
      if (hasNoVideo && hasNoPromptExt) {
        tooltipText = 'Please provide a video and a prompt.';
      } else if (hasNoVideo) {
        tooltipText = 'An input video is required to extend.';
      } else if (hasNoPromptExt) {
        tooltipText = 'Please enter a prompt describing what happens next.';
      }
      break;
  }
